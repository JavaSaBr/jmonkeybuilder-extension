...
public class SceneLoader implements AssetLoader {
     ...
     */
    public static void install(@NotNull Application application) {
     ...
     */
    public static void install(@NotNull Application application, @Nullable FilterPostProcessor processor) {
    ...
    @Override
    public Object load(@NotNull AssetInfo assetInfo) throws IOException {
